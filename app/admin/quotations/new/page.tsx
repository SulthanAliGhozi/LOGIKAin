  ...
  return (
    <main className="min-h-screen bg-[#f3f0ea] p-6 text-[#171717] md:p-10">
      <div className="flex items-center gap-2 text-xs font-medium text-black/50">
        ...
        <span>LOGIKAin</span>
        <span>/</span>
        <span className="text-[#b36f43]">NEW QUOTATION</span>
      </div>
      
      <div className="mt-8 mb-10 max-w-2xl">
        <h1 className="text-4xl font-extrabold tracking-tight">Create Quotation</h1>
        <p className="mt-2 text-sm text-black/50">Draft a new quotation for a client or lead.</p>
      </div>
